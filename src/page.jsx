    ...
    return (
        ...
        <div className="max-sm:scale-[0.75] max-sm:origin-center max-sm:p-6">
            ...
            <a href="/testing">
                ...
                <span className="absolute left-8 scale-[0.5] hover:scale-60 duration-300">
                    <svg
                    viewBox="0 0 24 24"
                    width="24"
                    height="24"
            ...
            {/* [@media(width&gt;=1920px)]:left-[calc(-33vw)]  */}
            <p>
            ...
            <div
            id="left-section"
            className="hidden lg:block fixed left-[calc(-53vw)] top-1/2 -translate-y-1/2 w-[500px] h-[500px]"
            >
            {/* xl:left-[calc(-50vw)] ...  transition-opacity duration-500 ease-in-out opacity-100 */}
                <div className="relative w-full h-full">
                    <div className="w-full h-full border border-dotted border-[#A0A4AB] rotate-45 absolute inset-0"></div>

                    <button
                    id="discover-button"
                    className="group inline-flex items-center justify-center gap-4 text-sm font-normal text-[#1A1B1C] h-9 absolute top-1/2 right-0 -translate-y-1/2 px-3 py-1"
                    >
                    {/* whitespace-nowrap rounded-md ... transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring cursor-pointer disabled:opacity-50 ... translate-x-1/5 xl:translate-x-1/6 [@media(width&gt;=1920px)]:translate-x-1/20 */}
                    ...
                    <span className="absolute left-4 top-2 scale-[0.9] rotate-180 group-hover:scale-105 duration-300">
                        ▶
                    </span>
            ...
            <div
            id="right-section"
            className="hidden lg:block fixed top-1/2 right-[calc(-53vw)] -translate-y-1/2 w-[500px] h-[500px]"
            >
                {/*  xl:right-[calc(-50vw)] ... transition-opacity duration-500 ease-in-out opacity-100 */}
            <div className="relative w-full h-full">
                <div className="w-full h-full border border-dotted border-[#A0A4AB] rotate-45 absolute inset-0"></div>
                ...
                <button
                    id="take-test-button"
                    className="group inline-flex items-center justify-center gap-4 text-sm font-normal text-[#1A1B1C] h-9 absolute top-1/2 left-0 -translate-y-1/2 px-3 py-1"
                >
                    {/* whitespace-nowrap rounded-md ... transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring cursor-pointer disabled:opacity-50 ... -translate-x-1/5 xl:-translate-x-1/6 [@media(width&gt;=1920px)]:-translate-x-1/20 */}
                    TAKE TEST
